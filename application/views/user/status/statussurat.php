            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <a href="<?= base_url('user/statussktm/' . $user['id']); ?>" class="btn">
                    ...
                    <!-- Earnings (Monthly) Card Example -->
                    <div class="col-xl-3 col-md-6 mb-4">
                        <a href="<?= base_url('user/statussklahir/' . $user['id']); ?>" class="btn">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                    ...
                    <!-- Earnings (Monthly) Card Example -->
                    <div class="col-xl-3 col-md-6 mb-4">
                        <a href="<?= base_url('user/statusskkematian/' . $user['id']); ?>" class="btn">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <a href="<?= base_url('user/statusskpindah/' . $user['id']); ?>" class="btn">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                    ...
                    <!-- Pending Requests Card Example -->
                    <div class="col-xl-3 col-md-6 mb-4">
                        <a href="<?= base_url('user/statusbansos/' . $user['id']); ?>" class="btn">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Surat Pendaftaran Bantuan Sosial</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-envelope fa-2x text-gray-800"></i>
                                        </div>
