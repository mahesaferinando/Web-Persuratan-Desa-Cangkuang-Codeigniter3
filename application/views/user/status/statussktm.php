<font color="black">
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-black-800 row justify-content-center">Status Pengajuan Surat Keterangan Tidak Mampu - Rumah Sakit</h1>
                            ...
                            <?php if (is_array($status) || is_object($status)) {
                                foreach ($status as $data1) { ?>
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <?php if ($data1->tglselesai_sktm == NULL) {
                                                echo " - ";
                                            } else { ?>
                                                <?php $originalDate = $data1->tglselesai_sktm;
                                                $newDate = strftime("%d %B %Y", strtotime($originalDate)); ?>
                                                <?php echo $newDate; ?>
                                            <?php
                                            }
